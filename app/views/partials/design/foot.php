        ...
        <script src="/assets/js/design/ao.js?cache-date=<?php esc($cache_date); ?>"></script>
        <script src="/assets/js/design/_ao.js?cache-date=<?php esc($cache_date); ?>"></script>
        <script src="/assets/js/design.js?cache-date=<?php esc($cache_date); ?>"></script>
